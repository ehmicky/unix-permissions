...
expectAssignable<PermissionNumber>(convert.number('a+x'))
expectAssignable<PermissionNumber>(convert.number({ all: { execute: true } }))
expectError(convert.number(''))

expectAssignable<PermissionStat>(convert.stat('111'))
expectAssignable<PermissionStat>(convert.stat(0o111))
expectAssignable<PermissionStat>(convert.stat('d--x--x--x'))
